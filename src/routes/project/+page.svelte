        ...
        <div class="my-container">
          <div class="my-container mt-[6.25rem]">
            ...
            <p class="text-[1rem] md:text-[1.313rem] text-[#4B4B4B] mb-[2.813rem] max-w-[52rem]">
              Energy efficiency simply means using less energy to perform the same
              task – that is, eliminating energy waste. Energy efficiency brings a
              variety of ecological benefits
            </p>
            <div class="flex flex-wrap gap-[1.5rem]">
              <ProjectCard
                name="GFS Mega twin tower"
                img="/images/project/project-1.png"
              />
              <ProjectCard
                name="GFS Mega tower"
                img="/images/project/project-2.png"
              />
