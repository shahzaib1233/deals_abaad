	...
	<div class="my-container">
		<div class="flex flex-wrap gap-[2rem] py-[4rem]">
			<div class="flex-1 flex flex-col gap-[2rem] min-w-[15rem]">
				...
				<p class="text-white">
					DealsAbaad’s aim is to provide confidence and integrity to people to trust this industry
					specially overseas investors.
				</p>
				<p class="text-white">Powered by Abdur Rahman Bin Auf Associates (Private) Limited</p>
				<div class="flex gap-[0.938rem] items-center">
					<a href="https://www.facebook.com/DealsAbaad" target="_blank"
						><img src="/logos/facebook.svg" alt="" /></a
					>
					<img src="/logos/instagram.svg" alt="" />
					<img src="/logos/twitter.svg" alt="" />
					<img src="/logos/linkedin.svg" alt="" />
					<a href="https://www.youtube.com/@dealsabaad/" target="_blank"
						><img src="/logos/youtube.svg" alt="" /></a
					>
				</div>
			</div>
