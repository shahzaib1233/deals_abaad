...
<div class="my-container pt-[14.25rem]">
	...
	>
		<div class="flex flex-col md:flex-row mb-[1.2rem] gap-[2rem]">
			<div class=" flex">
				<!-- svelte-ignore a11y-img-redundant-alt -->
				<img
					src="/images/bookings/booking-img.png"
					alt="Image"
					class="mr-2 rounded-lg w-auto md:w-[35rem] h-auto md:h-[17rem]"
				/>
			</div>
			<div class="">
				<div class="flex flex-col justify-left mt-2 ml-0 md:ml-[3.2rem]">
					<h2 class="mb-2 font-bold text-[1.4rem]">Kings Scenic Mall Sukkur</h2>
					<span class="mb-2 text-[#4B4B4B]">Karachi</span>
					...
					<div class="mb-2 mt-8 flex flex-row">
						<img src="/images/bookings/heart.png" alt="" />
						<a href="" class="ml-[1rem] underline font-bold text-[1.1rem]"> Show details </a>
					</div>
				</div>
			</div>
		</div>
