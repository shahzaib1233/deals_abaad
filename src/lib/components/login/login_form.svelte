...
<form class="flex flex-col w-[25rem]" on:submit|preventDefault={submit}>
    <h2 class="text-[2rem] md:text-[2.8rem] font-bold mb-[1.7rem]">
      Welcome Back
    </h2>
    ...
    <div class="self-end mb-8">
      <a href="/forget-password" class="underline text-[#111111]">
        Forget your password
      </a>
    </div>
    <Button
      className="mb-[0.563rem] h-[2.5rem]"
      type="submit"
      {loading}
      label="Login"
   />
    ...
    <div class="mb-[1.4rem]">
      ...
      <a href="/register" class="underline text-[#111111]">
        Register Now
      </a>
    </div>
    ...
    <button
      class="text-[#1A202C] mt-[1.063rem]"
    >
      <div class="flex items-center gap-[0.688rem] border flex items-center justify-center h-[2.5rem] rounded-md">
